...
namespace BTL.Views.Class
{
    public partial class Class_Add : Form
    {
        ...
        {
            if (txt_Name.Texts.IsNullOrEmpty())
            {
            ...
            int course = int.Parse(cmb_Course.SelectedValue.ToString());
            int semester = int.Parse(cmb_Semester.SelectedValue.ToString());
            if (Class_Repository.Add(new Classes(0, course, semester, name)))
            {
                added = true;
                this.Dispose();
            }
